package com.mysite.sitebackend.account.vo.service;
...
public class AccountService {
    ...
    public boolean signUp(AccountInput accountInput) {
        if (accountInput.getPassword().equals(accountInput.getConfirmPassword())) {
            ...
            a1.setPassword(passwordEncoder.encode(accountInput.getPassword()));
            a1.setRole("USER");
    ...
    public AccountSighInDto signIn(AccountInput accountInput) {
        ...
        if (opAccount.isPresent()) {
            ...
            if (passwordEncoder.matches(account.getPassword(), accountInput.getPassword())) {
    ...
    public boolean pwReset(AccountInput accountInput) {
        ...
        if (passwordEncoder.matches(accountInput.getPassword(), accountInput.getConfirmPassword())) {
